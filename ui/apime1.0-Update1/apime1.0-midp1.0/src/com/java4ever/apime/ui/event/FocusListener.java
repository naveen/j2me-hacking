...
{
	/**
	 * Invocado cuando un componente recibe el foco.
	 *
	 * @param component Componente que ha efectuado el evento
	 *
	 * @see IComponent
	 */
	public void focusGained(IComponent component);

	/**
	 * Invocado cuando un componente pierde el foco.
	 *
	 * @param component Componente que ha efectuado el evento
	 *
	 * @see IComponent
	 */
	public void focusLost(IComponent component);
}